...
include('../model/mostra_favoritos_model.php');
?> 
...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" href="../assets/css/favoritos_view.css">
...
<body>
	...
	<h1 class="primeiro_h1">Meus Favoritos</h1>
	...
	while ($registro = mysqli_fetch_array($resultado))
 {
	...
	<td>
		<button class="favoritar_btn"><a class="ref" href="../model/remover_favoritos_model.php?id= <?php echo $id ?>">Remover dos Favoritos</a></button> 
	</td>
	</td>
	</tr>
